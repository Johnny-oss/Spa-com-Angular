...
export class HomeComponent implements OnInit {
  ...
  listaAlunos: alunos[] = [
    { nome: 'Johnny', idade: 26, email: 'johnny.melo15@gmail.com', curso: 'Análise e Desenvolvmento de Sistemas' },
    { nome: 'Teste', idade: 25, email: 'Teste@gmail.com', curso: 'Ciência da Computação' },
